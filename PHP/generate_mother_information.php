...
<label class="right block" for="mother_alive_yes">
    <input type="radio" class="revealers" name="mother_alive" id="mother_alive_yes" value="YES" <?php if(isset($_POST['mother_alive']) && $_POST['mother_alive'] == "YES"){echo "checked";} ?>>بله</input>
</label>
<label class="right block" for="mother_alive_no">
    <input type="radio" class="revealers" name="mother_alive" id="mother_alive_no" value="NO" <?php if(isset($_POST['mother_alive']) && $_POST['mother_alive'] == "NO"){echo "checked";} ?>>خیر</input>
</label>
